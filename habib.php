...
<head>
          ...
          <link rel="stylesheet" href="css-1/Detail.css">
...
<div class="card mb-3">
  <div class="row">
    <div class="col-md-4">
    <img src="assets/hb.jpg" class="card-img-top" alt="ica">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Risqan Al Habib</h5>
        <p class="card-text"><small>Rekayasa Perangkat Lunak</small></p>
<div class="content">
		<table>
			<tr>
				<td> Email :</td>
				<td> risqanalhabib60@gmail.com </td>
			</tr>
      ...
      <td > Tempat Tinggal : </td>
				<td> Kp Dalam Gadur</td>
      </tr>

      <tr>
      <td > Tempat tanggal lahir :</td>
				<td> Pauh Kambar, 23 Maret 2007 </td>
      </tr>
